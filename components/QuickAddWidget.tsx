      ...
      <div className="fixed bottom-6 right-6 z-50">
            ...
            >
              ...
              >
                <Button
                  ...
                  className="group relative h-12 gap-2 overflow-hidden border-emerald-500 bg-emerald-600 pr-4 shadow-lg hover:bg-emerald-700 hover:shadow-xl"
                >
              ...
              >
                <Button
                  ...
                  className="group relative h-12 gap-2 overflow-hidden border-red-500 bg-red-600 pr-4 shadow-lg hover:bg-red-700 hover:shadow-xl"
                >
        ...
        >
          <Button
            ...
            className={cn(
              "group relative h-14 w-14 overflow-hidden rounded-full shadow-2xl transition-all duration-300",
              isOpen
