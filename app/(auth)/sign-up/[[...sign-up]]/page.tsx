        ...
        appearance={{
          elements: {
            ...
            socialButtonsBlockButton:
              "bg-secondary hover:bg-secondary/90 text-secondary-foreground border-2 border-border/60 transition-all duration-300 h-12 2xl:h-14 px-2 2xl:px-6 rounded-xl hover:scale-[1.02] hover:shadow-lg hover:border-primary/40 font-medium text-sm 2xl:text-base",
            ...
            formFieldLabel: "text-foreground font-bold text-sm 2xl:text-base mb-2 2xl:mb-3",
            formFieldInput:
              "bg-background backdrop-blur-sm border-2 border-border text-foreground placeholder:text-muted-foreground/50 focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 focus:ring-offset-card focus:border-primary rounded-xl h-12 2xl:h-14 px-2 2xl:px-6 transition-all duration-300 hover:border-primary/60 font-medium text-base 2xl:text-lg",
