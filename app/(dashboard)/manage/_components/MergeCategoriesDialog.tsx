...
export default function MergeCategoriesDialog({ type, categories, trigger }: Props) {
    ...
    const handleMerge = () => {
        ...
        if (confirm(`Are you sure you want to merge "${sourceCategory}" into "${targetCategory}"? \n\nThis will move ALL transactions and delete "${sourceCategory}". This action cannot be undone.`)) {
