...
export function WorkspaceJoinQRCode({ workspaceId }: { workspaceId: string }) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-md bg-gradient-to-b from-background to-primary/5 border-primary/20 overflow-hidden">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative bg-white p-4 rounded-3xl shadow-2xl border border-white/20">
                            {isLoading || isRefetching ? (
                                ...
                                <div className="h-[200px] w-[200px] flex items-center justify-center text-muted-foreground text-center p-4">
