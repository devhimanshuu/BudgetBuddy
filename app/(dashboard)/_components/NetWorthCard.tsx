    ...
    <SkeletonWrapper isLoading={statsQuery.isFetching}>
      <GlassCard className="h-full">
        <div className="flex flex-col h-full">
          ...
          <CardHeader className="relative 3xl:p-8 shrink-0">
          ...
          <CardContent className="relative flex flex-col justify-between grow space-y-4 3xl:space-y-6 3xl:p-8 3xl:pt-0">
            {/* Main Balance */}
            <div className="pt-2">
              <p className="text-sm text-muted-foreground 3xl:text-base">Total Balance</p>
              <p
                className={cn(
                  "text-4xl font-bold 3xl:text-5xl mt-1",
              ...
              {balanceChange !== 0 && (
                <p className="text-sm text-muted-foreground 3xl:text-base mt-2">
                  {balanceChange > 0 ? "+" : ""}
